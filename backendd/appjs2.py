...
def calculate_metrics(df):
    ...
    log_distribution = df['attack_type'].value_counts().to_dict()  # Ubah ke dictionary
...
def create_summary_tables(metrics, attack_characteristics):
    ...
    distribution_table = {
        'Kategori': list(attack_characteristics.keys()),
        'Jumlah': list(metrics['distribution'].values())  # Sesuaikan dengan data Anda
    }
