...
# Fungsi untuk mengevaluasi performa model dengan metrik
def calculate_metrics(df):
    """Evaluasi performa model dengan metrik evaluasi standar"""
    y_true = df['is_attack']
    y_pred = df['is_attack']
...
try:
    while True:
        ...
        df_train = process_logs(['log_sql.log', 'log_bruteforce.log'])
        ...
        print("Hasil evaluasi telah disimpan di hasil_evaluasi_model.json")
        time.sleep(10)
